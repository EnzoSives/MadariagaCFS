...
if(stockProducto1<1){
  stockProducto1=prompt("El stock no puede ser inferior a 1, ingrese de nuevo el stock");
};
...
let productoAdquirido:number = Number(prompt("Digite 1 para comprar", producto1 + " 2 para comprar", producto2 + " 3 para comprar", producto3));
